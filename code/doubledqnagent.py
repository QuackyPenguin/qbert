...
class DoubleDQNAgent:
    def __init__(self, game: QbertGameAI, input_dims, n_actions, batch_size = 32, epsilon = 1.0, gamma = 0.9, 
                 mem_size = 100_000, lr = 0.001, eps_min=0.001, eps_dec=1e-2, replace = 1000) -> None:
        self.n_games = 1
        ...
        self.q_eval = DeepQNetwork(input_dims, n_actions, lr=self.lr, filename='doubleq_eval')
        self.q_next = DeepQNetwork(input_dims, n_actions, lr=self.lr, filename='doubleq_next')
